  ...
  return (
    <div className={"bg-white border-b"}>
      ...
      <div className={"flex flex-row justify-between px-4"}>
        <div
          className={
            "overflow-hidden rounded-full w-[100px] h-[100px] bg-cover bg-center border-2 border-white -mt-[32px]"
          }
          style={{
        ...
        <div className={"pt-4"}>
          <div
            className={
              "border border-neutral-200 w-12 h-12 rounded-full flex justify-center items-center"
            }
          >
            <FiShare width="24px" />
          </div>
      ...
      <div className={"p-4"}>
        <div className={"text-[20px] font-semibold"}>{AppConfig.name}</div>
        <div className={"flex flex-row text-neutral-500 gap-1 items-center"}>
          <div className={"text-[12px]"}>@{AppConfig.username}</div>
          <div>•</div>
